...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_6x9_6(
                 ...
                 _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, _______, _______,            _______, _______, KC_UP,   KC_7,    KC_8,    KC_9,    KC_PAST, _______, _______, _______,
                 _______, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  _______, _______,            _______, _______, KC_DOWN, KC_4,    KC_5,    KC_6,    KC_PPLS, _______, _______,
